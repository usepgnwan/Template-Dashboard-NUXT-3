...
<template>
  <div class="relative">
    ...
    <label
      ...
      :for="props.id"
      class="absolute text-gray-500 duration-300 transform  -translate-y-4 top-[1.39rem] z-10 origin-[0] bg-transparent dark:bg-gray-900 px-2 pr-4 peer-focus:px-2 peer-focus:pr-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-[1.2rem] peer-focus:text-pool-50 peer-focus:text-[10px] peer-focus:-translate-y-4 rtl:peer-focus:left-auto start-1 w-full"
      :class="{
        'text-[10px]': isActive,
        'text-sm': !isActive
      }"
